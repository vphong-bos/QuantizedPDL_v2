...
from model_wrappers.model.pdl.embeded_head import PanopticDeepLabInsEmbedHead
from model_wrappers.model.pdl.postprocessing import get_panoptic_segmentation
from model_wrappers.model.pdl.resnet import ResNet
from model_wrappers.model.pdl.semantic_head import PanopticDeepLabSemSegHead, ShapeSpec
...
class PytorchPanopticDeepLab(nn.Module):
    ...
    def load_model_weights(self, weights_path: str, strict: bool = True):
        ...
        try:
            ...
            from model_wrappers.model.pdl.preprocessing import fuse_imagenet_normalization
